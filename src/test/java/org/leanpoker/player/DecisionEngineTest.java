...
public class DecisionEngineTest {
    ...
    @Test
    public void makeBetWithoutDoubleHandThreeCardReturnsFalse2() throws Exception {
        List<Card> target = Arrays.asList(new Card("8", "hearts"), new Card("3", "clubs"), new Card("6", "Spades"));
